...
#include "EngineUtilsModule.h"
#include "Modules/ModuleManager.h"

#define LOCTEXT_NAMESPACE "EngineUtils"

class FEngineUtilsModule : public IEngineUtilsModule
{
...
IMPLEMENT_MODULE(FEngineUtilsModule, EngineUtils)

void FEngineUtilsModule::StartupModule()
{
...
void FEngineUtilsModule::ShutdownModule()
{
